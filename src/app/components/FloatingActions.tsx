  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-6 md:w-96 z-40 flex flex-col gap-2">
      ...
      <div className="flex justify-center">
        <Badge className="text-lg md:text-xl font-medium">
      ...
      <Button 
        asChild
        size="lg"
        className="text-xl md:text-3xl md:h-14 shadow-lg rounded-full"
      >
        <a 
      ...
      <div className="flex gap-2">
        <Button
          ...
          variant="outline"
          size="sm"
          className="flex-1 md:h-12 md:text-xl rounded-full font-light"
        >
          <a 
